...
```{r q1_shapiro}
shap_res <- shapiro.test(df$price); shap_res
log_shap_res <- shapiro.test(df$price_log); log_shap_res
```
...
m2 <- aov(price ~ aux_age * fuelType, data = df)
summary(m2)
