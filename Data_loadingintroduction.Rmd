...
```{r}
# setwd("E:/Docencia_UPC/MDS-SIM/Assignment 1") #Set working directory
```
...
df1 <- read.table("data/audi.csv",header=T, sep=",")
df1$manufacturer <- "Audi"
df2 <- read.table("data/bmw.csv",header=T, sep=",")
df2$manufacturer <- "BMW"
df3 <- read.table("data/merc.csv",header=T, sep=",")
df3$manufacturer <- "Mercedes"
df4 <- read.table("data/vw.csv",header=T, sep=",")
df4$manufacturer <- "VW"
...
filepath<-"E:/Docencia_UPC/MDS-SIM/Assignment 1/"
